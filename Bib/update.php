...
{
    $text = $_POST['message3'];
    $updateQuery = "UPDATE bib SET message = '$text' WHERE bib.level = 3";
    $update = $connection->query($updateQuery);
